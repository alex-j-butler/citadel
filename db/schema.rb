...
ActiveRecord::Schema.define(version: 20180215114806) do
  ...
  create_table "league_match_booked_times", id: :serial, force: :cascade do |t|
    ...
    t.index ["match_id"], name: "index_league_match_booked_times_on_match_id"
    t.index ["status"], name: "index_league_match_booked_times_on_status"
  end
